  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <h1 className="font-serif text-4xl text-[var(--accent-soft)]">Interiors Contact</h1>
        <p className="mt-4 text-[var(--text-soft)]">Discuss your residential or commercial interior requirement.</p>
        <div className="mt-6">
