  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <h1 className="font-serif text-4xl text-[var(--accent-soft)]">Terms & Conditions</h1>
        ...
        <Link to="/" className="mt-6 inline-flex min-h-11 items-center rounded-full border border-white px-5 text-sm text-[var(--accent-soft)]">
          Back to Home
        </Link>
        </div>
      </section>
